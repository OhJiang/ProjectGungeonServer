...
namespace Geek.Server.Core.Net.Http
{
	public class HttpResult
	{
		...
		public static readonly HttpResult Success = new HttpResult(Stauts.Success, "ok");
		public static readonly HttpResult Undefine = new HttpResult(Stauts.UnDefine, "undefine command");
